...
class NuevoAgente extends StatefulWidget {
  final Function addAgente;
  NuevoAgente(this.addAgente);

  @override
  State<NuevoAgente> createState() => _NuevoAgenteState();
}

class _NuevoAgenteState extends State<NuevoAgente> {
